$(document).ready(function () {
    ...
    var question18 = {
        ...
        d: "Hoyt Wilhelm",
        correct: "d",
        explain: "Hoyt Wilhelm was nearly 30 years old when he entered the Majors and pitched until he was nearly 50. He was inducted into the Hall of Fame in 1985."
    }
    var question19 = {
    ...
    function timeEnded(outcome) {
        ...
        if (outcome == "expired" || outcome == "wrong") {
            ...
            $(".answer[value=" + tempValue + "]").addClass("correct_brief");
